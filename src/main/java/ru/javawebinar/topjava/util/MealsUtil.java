...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 11, 0), "Завтрак чемпиона", 750, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 12, 0), "Обед чемпиона", 1200, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 21, 0), "Легкий ужин", 200, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Ночной перекус на бульваре роз", 100, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 11, 0), "Завтрак чемпиона", 1200, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 12, 0), "Обед чемпиона", 750, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 21, 0), "Ужин чемпиона", 250, 2)
    );
